<template>
  <div>
		...
		<el-table style="margin-top: 20px;" :data="tableData" border>
			...
			<el-table-column label="单号" prop="outTradeNo"></el-table-column>
...
function pay(outTradeNo, price) {
	post('/elder/pay', { out_trade_no: outTradeNo, total_amount: price }, content => {
